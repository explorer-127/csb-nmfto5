...
var moarCardsSingleCardMain = function (input) {
  ...
  var shuffleCardDeck1 = shuffleCards(cardDeck1);

  var drawnCard = shuffleCardDeck1.pop();

  var myOutputValue = `Your card is ${drawnCard.name} of ${drawnCard.suit}.`;
...
var moarCardsLowCardMain = function (input) {
  ...
  var computerCard = shuffleCardDeck1.pop();
  var playerCard = shuffleCardDeck1.pop();

  if (computerCard.rank < playerCard.rank) {
    var myOutputValue = `Computer drew ${computerCard.name} of ${computerCard.suit}.<br>
    You drew ${playerCard.name} of ${playerCard.suit}.<br>
    Computer wins.`;
